...
(() =>
{
  ...
  const
    criticalErrors = myappEnvValidator.errors.critical,
    generalErrors = myappEnvValidator.errors.general

  let
    title = 'Setup errors detected!',
    html = '<div style="text-align: left;">'

  if ( myappEnvValidator.env === 'prod' )
  {
  ...
  const envLabel = {
    ...
    'stg': 'Staging',
    'loc': 'Local',
  }[ myappEnvValidator.env ].toUpperCase()
